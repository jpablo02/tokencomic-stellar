...
const Photo = () => {
  return (
    <div className="relative w-full h-full">
      ...
      >
        <motion.svg
          className="w-[400px] xl:w-[506px] h-[400px] xl:h-[506px] absolute top-0 left-0"
          fill="transparent"
          viewBox="0 0 506 506"
        ...
        <motion.div
          className="relative w-[400px] h-[400px] xl:w-[506px] xl:h-[506px] mix-blend-lighten xl:pr-20"
          initial={{ opacity: 0 }}
          animate={{
            opacity: 1,
